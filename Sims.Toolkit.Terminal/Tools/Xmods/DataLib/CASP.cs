...
namespace Sims.Toolkit.Core.Tools.Xmods.DataLib
{
    public class CASP       //Sims 4 CASP resource
    {
        ...
        {
            get { return (this.occultBitField & (uint)XmodsEnums.OccultTypesDisabled.Human) > 0; }
            set
            {
                if (value) { this.occultBitField |= (uint)XmodsEnums.OccultTypesDisabled.Human; }
                else { this.occultBitField &= (uint)(~XmodsEnums.OccultTypesDisabled.Human); }
            }
        }
        public bool OccultDisableForAlien
        {
            get { return (this.occultBitField & (uint)XmodsEnums.OccultTypesDisabled.Alien) > 0; }
            set
            {
                if (value) { this.occultBitField |= (uint)XmodsEnums.OccultTypesDisabled.Alien; }
                else { this.occultBitField &= (uint)(~XmodsEnums.OccultTypesDisabled.Alien); }
            }
        }
        public bool OccultDisableForVampire
        {
            get { return (this.occultBitField & (uint)XmodsEnums.OccultTypesDisabled.Vampire) > 0; }
            set
            {
                if (value) { this.occultBitField |= (uint)XmodsEnums.OccultTypesDisabled.Vampire; }
