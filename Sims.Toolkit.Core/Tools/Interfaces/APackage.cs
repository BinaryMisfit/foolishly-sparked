...
namespace Sims.Toolkit.Core.Tools.Interfaces
{
    ...
    public abstract class APackage : AApiVersionedFields, IPackage
    {
        ...
        /// </summary>
        [ElementPriority(5)]
        public abstract int UserVersionMinor { get; }

        /// <summary>
        /// Package header: unused
        /// </summary>
        [ElementPriority(6)]
        public abstract int Unused1 { get; }
        ...
        /// </summary>
        [ElementPriority(8)]
        public abstract int UpdatedTime { get; }

        /// <summary>
        /// Package header: unused
        /// </summary>
        [ElementPriority(9)]
        public abstract int Unused2 { get; }
        ...
        /// </summary>
        [ElementPriority(11)]
        public abstract int IndexRecordPositionLow { get; }
        ...
        /// </summary>
        [ElementPriority(13)]
        public abstract int Unused3 { get; }
        ...
        /// </summary>
        [ElementPriority(14)]
        public abstract IEnumerable<IResourceIndexEntry> GetResourceList { get; }
        ...
        /// <summary>
        /// Releases all the resources used by <see cref="APackage"/>
        /// </summary>
        ...
        /// <returns>IPackage reference to an empty package</returns>
        public static IPackage NewPackage(int APIversion, int major)
        {
            throw new NotImplementedException();
        }
