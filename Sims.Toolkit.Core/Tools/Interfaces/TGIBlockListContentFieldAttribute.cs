...
namespace Sims.Toolkit.Core.Tools.Interfaces
{
    ...
    {
        private string tgiBlockListContentField;
        /// <summary>
        ...
        public static string GetTGIBlockListContentField(Type t, string index)
        {
            ...
            return pi == null ? null : (from Attribute attr in pi.GetCustomAttributes(typeof(TGIBlockListContentFieldAttribute), true) select (attr as TGIBlockListContentFieldAttribute)?.TGIBlockListContentField).FirstOrDefault();
        }
    }
}
