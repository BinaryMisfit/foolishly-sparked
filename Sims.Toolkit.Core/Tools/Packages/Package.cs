...
namespace Sims.Toolkit.Core.Tools.Packages
{
    ...
    public class Package : APackage
    {
        ...
        public override void SaveAs(Stream s)
        {
            ...
            uint indexType = (uint) (lIh.Count <= 1 ? 0x04 : 0x00) | (uint) (lG.Count <= 1 ? 0x02 : 0x00) |
                             (uint) (lT.Count <= 1 ? 0x01 : 0x00);
        ...
        {
            return OpenPackage(APIversion, packagePath, false);
        }
        ...
        {
            return new Package(APIversion,
                new FileStream(packagePath, FileMode.Open, readwrite ? FileAccess.ReadWrite : FileAccess.Read,
                    FileShare.ReadWrite));
        }
        ...
        public static new void ClosePackage(int APIversion, IPackage pkg)
        {
            ...
            if (p == null) return;
            if (p.packageStream != null)
            {
                try
                {
                    p.packageStream.Close();
                }
                catch
                {
                }

                p.packageStream = null;
            }
        ...
        {
            get { return BitConverter.ToInt32(header, 4); }
        }
        ...
        {
            get { return BitConverter.ToInt32(header, 8); }
        }
        ...
        /// </summary>
        [ElementPriority(4)]
        public override int UserVersionMajor
        {
            get
            {
                byte[] res = new byte[4];
                Array.Copy(header, 0xc, res, 0, res.Length);
        ...
        /// </summary>
        [ElementPriority(4)]
        public override int UserVersionMinor
        {
            get
            {
                byte[] res = new byte[4];
                Array.Copy(header, 0x10, res, 0, res.Length);
                return BitConverter.ToInt32(res, 0);
            }
        }
        ...
        /// </summary>
        [ElementPriority(4)]
        public override int Unused1
        {
            get
            {
                byte[] res = new byte[4];
                Array.Copy(header, 0x14, res, 0, res.Length);
                return BitConverter.ToInt32(res, 0);
            }
        }
        ...
        /// </summary>
        [ElementPriority(4)]
        public override int CreationTime
        {
            get
            {
                byte[] res = new byte[4];
                Array.Copy(header, 0x18, res, 0, res.Length);
                return BitConverter.ToInt32(res, 0);
            }
        }
        ...
        /// </summary>
        [ElementPriority(4)]
        public override int UpdatedTime
        {
            get
            {
                byte[] res = new byte[4];
                Array.Copy(header, 0x1c, res, 0, res.Length);
                return BitConverter.ToInt32(res, 0);
            }
        }
        ...
        /// </summary>
        [ElementPriority(4)]
        public override int Unused2
        {
            get
            {
                byte[] res = new byte[4];
                Array.Copy(header, 0x20, res, 0, res.Length);
                return BitConverter.ToInt32(res, 0);
            }
        }
        ...
        {
            get { return BitConverter.ToInt32(header, 36); }
        }
        ...
        /// </summary>
        [ElementPriority(6)]
        public override int IndexRecordPositionLow
        {
            get
            {
                byte[] res = new byte[4];
                Array.Copy(header, 40, res, 0, res.Length);
                return BitConverter.ToInt32(res, 0);
            }
        }
        ...
        {
            get { return BitConverter.ToInt32(header, 44); }
        }
        ...
        /// </summary>
        [ElementPriority(8)]
        public override int Unused3
        {
            get
            {
                byte[] res = new byte[12];
                Array.Copy(header, 48, res, 0, res.Length);
                return BitConverter.ToInt32(res, 0);
            }
        }
        ...
        /// </summary>
        [ElementPriority(9)]
        public override int Unused4
        {
            get { return BitConverter.ToInt32(header, 60); }
        }
        ...
        /// </summary>
        [ElementPriority(11)]
        public override byte[] Unused5
        {
            get
            {
                byte[] res = new byte[28];
                Array.Copy(header, 68, res, 0, res.Length);
                return res;
            }
        }
        ...
        /// </summary>
        [ElementPriority(12)]
        public override Stream HeaderStream
        {
        ...
        /// </summary>
        [ElementPriority(13)]
        public override uint Indextype
        {
            get { return (GetResourceList as PackageIndex).Indextype; }
        }
        ...
        /// </summary>
        [ElementPriority(14)]
        public override IEnumerable<IResourceIndexEntry> GetResourceList
        {
            get { return Index; }
        }
        ...
        static bool NameMatch(string[] names, TypedValue[] values, IResourceIndexEntry target)
        {
            for (int i = 0; i < names.Length; i++)
                if (!target.ContentFields.Contains(names[i]) || !values[i].Equals(target[names[i]]))
                    return false;
            return true;
        }
        ...
        {
            return Index.Find(x => !x.IsDeleted && FlagMatch(flags, values, x));
        }
        ...
        {
            return Index.Find(x => !x.IsDeleted && NameMatch(names, values, x));
        }
        ...
        [MinimumVersion(1)]
        [MaximumVersion(recommendedApiVersion)]
        public override IResourceIndexEntry Find(Predicate<IResourceIndexEntry> Match)
        {
            return Index.Find(x => !x.IsDeleted && Match(x));
        }
        ...
        public override List<IResourceIndexEntry> FindAll(uint flags, IResourceIndexEntry values)
        {
            return Index.FindAll(x => !x.IsDeleted && FlagMatch(flags, values, x));
        }
        ...
        [MaximumVersion(recommendedApiVersion)]
        [Obsolete("Please use FindAll(Predicate<IResourceIndexEntry> Match)")]
        public override List<IResourceIndexEntry> FindAll(string[] names, TypedValue[] values)
        {
            return Index.FindAll(x => !x.IsDeleted && NameMatch(names, values, x));
        }
        ...
        [MinimumVersion(1)]
        [MaximumVersion(recommendedApiVersion)]
        public override List<IResourceIndexEntry> FindAll(Predicate<IResourceIndexEntry> Match)
        {
            return Index.FindAll(x => !x.IsDeleted && Match(x));
        }
        ...
        private Package(int requestedVersion, int major = 2)
        {
            if (!majors.Contains(major))
                throw new InvalidDataException("Expected major version(s) '" + string.Join(", ", majors) +
                                               "'.  Found '" + major.ToString() + "'.");
                ...
                if (checking)
                    if (chunk.Length != (int) ie.Memsize)
                        throw new OverflowException(string.Format(
                            "packedChunk, dirty resource - T: 0x{0:X}, G: 0x{1:X}, I: 0x{2:X}: Length expected: 0x{3:X}, read: 0x{4:X}",
            ...
            else
            {
                if (checking)
                    if (packageStream == null)
                        throw new InvalidOperationException(string.Format(
                            "Clean resource with undefined \"current package\" - T: 0x{0:X}, G: 0x{1:X}, I: 0x{2:X}",
                ...
                if (checking)
                    if (chunk.Length != (int) ie.Filesize)
                        throw new OverflowException(string.Format(
                            "packedChunk, clean resource - T: 0x{0:X}, G: 0x{1:X}, I: 0x{2:X}: Length expected: 0x{3:X}, read: 0x{4:X}",
        ...
        static byte[] stringToBytes(string s)
        {
            ...
            int i = 0;
            foreach (char c in s) bytes[i++] = (byte) c;
            return bytes;
        }
        ...
        {
            string s = "";
            foreach (byte b in bytes) s += (char) b;
            return s;
        }
        ...
        void setIndexcount(BinaryWriter w, int c)
        {
            w.BaseStream.Position = 36;
            w.Write(c);
        }

        void setIndexsize(BinaryWriter w, int c)
        {
            w.BaseStream.Position = 44;
            w.Write(c);
        }

        void setIndexversion(BinaryWriter w)
        {
            w.BaseStream.Position = 60;
            w.Write(3);
        }

        void setIndexposition(BinaryWriter w, int c)
        {
        ...
        void setUnused4(BinaryWriter w, int c)
        {
            w.BaseStream.Position = 0x3c;
            w.Write(c);
        }
        ...
        private PackageIndex Index
        {
            get
            {
                if (index == null)
                {
                    index = new PackageIndex(packageStream, Indexposition, Indexcount);
